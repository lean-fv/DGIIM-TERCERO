...
class AIPlayer: public Player{
    ...
    public:
        ...
        /**
         * @brief Heurística que da una valoracion a un estado del tablero.
         * 
         * @param estado Instancia de Parchis con el estado actual de la partida.
         * @param jugador Id del jugador actual (0 o 1)
         * @return double 
        ...
        /**
         * @brief Funcion que devuelve una valoracion segun el poder del jugador.
         * 
         * @param power Poder del jugador
         * @return double 
         */
        static double PowerValue(int power);
};
