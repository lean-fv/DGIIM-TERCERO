...
void funcion_filosofos( int id )
{
    ...
    while ( true )
    {
        string 
            ...
            ten_izq_actual= tenedores[id_ten_izq/2],
            ten_der_actual= tenedores[id_ten_der/2];


        cout <<"Filósofo " << filosofo_actual<< " solicita ten. izq." <<ten_izq_actual <<endl;
        
        MPI_Ssend(&msg,1,MPI_INT,id_ten_izq,0,MPI_COMM_WORLD);

        cout <<"Filósofo " <<filosofo_actual <<" solicita ten. der." <<ten_der_actual <<endl;
        ...
        cout <<"Filósofo " <<filosofo_actual <<" suelta ten. izq. " <<ten_izq_actual <<endl;

        MPI_Ssend(&msg,1,MPI_INT,id_ten_izq,0,MPI_COMM_WORLD);

        cout<< "Filósofo " <<filosofo_actual <<" suelta ten. der. " <<ten_der_actual <<endl;
