...
void funcion_filosofos( int id )
{
    ...
    while ( true )
    {
        cout <<"Filósofo " <<id << " solicita 1er tenedor." <<id_ten_izq <<endl;
        
        MPI_Ssend(&msg,1,MPI_INT,id_tenedor_1,0,MPI_COMM_WORLD);

        cout <<"Filósofo " <<id <<" solicita 2o tenedor." <<id_ten_der <<endl;
        ...
        cout <<"Filósofo " <<id <<" suelta 1er tenedor. " <<id_ten_izq <<endl;

        MPI_Ssend(&msg,1,MPI_INT,id_tenedor_1,0,MPI_COMM_WORLD);

        cout<< "Filósofo " <<id <<" suelta 2o tenedor." <<id_ten_der <<endl;
