...
const unsigned 
    ...
    num_hebras_prod = 10 , //numero de hebras productoras
    num_hebras_cons = 5, //numero de hebras consumidoras
    //-------------------------------------------------------------------
...
int primera_libre=0; //primera posicion libre del buffer.
...
{
   cout << "-----------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores multiples (solución LIFO)." << endl
        << "------------------------------------------------------------------" << endl
        << flush ;
